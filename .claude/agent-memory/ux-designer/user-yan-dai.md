...
Prefers analysis that is immediately actionable by the builder — rules should be floor-plan-level constraints, not decoration-pass aspirations.

The game is a 1-4 player first-person co-op extraction game set in Municipal Debt Noir aesthetic. Art bible and AGENTS.md are the authoritative documents for all style and identity decisions.
