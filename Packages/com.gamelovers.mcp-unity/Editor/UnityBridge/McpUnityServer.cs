    ...
    public class McpUnityServer : IDisposable
    {
        ...
        public void StartServer()
        {
            ...
            try
            {
                ...
                // Windows: lingering CLOSE_WAIT/TIME_WAIT sockets from a previous domain's
                // server otherwise block the rebind after assembly reloads, leaving a
                // half-dead listener that accepts TCP but never completes WS handshakes.
