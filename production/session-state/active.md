...
Designing the first designated-commission map: **Earth Coast No.1 — Abandoned Pre-Sale Tower**
...
- Objective = sales scale model (architectural display model) — "the unbuilt Earth dream as a collectible"
...
- **Playable**: HQ + Snow_Lotus_01 (White-Spine Snow Lotus) mission loop
...
- Mission taxonomy = three tiers: Free Salvage / Commissioned Job / Black Commission (the moral slope)
- Hostile takeover threat = narrative events only (letters, visitors), no 0-100 UI bar
- Endgame trigger = all story missions complete → Immigration Qualification Review (moral choice, not money threshold)
...
- `docs/world-background-2098.md` — Phase 4 officially named Black Commission, design note added
